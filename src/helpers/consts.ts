...
export const PLACEMENT_TYPE_WEAPON = "WEAPON";
...
export const PLACEMENT_TYPE_WEAPON_PICKUP = "WEAPON_PICKUP";
...
export const PLACEMENT_TYPE_RABBIT = "RABBIT";
export const PLACEMENT_TYPE_PRINCESS = "PRINCESS";

export const PLACEMENT_TYPE_SWITCH_DOOR = "SWITCH_DOOR";
export const PLACEMENT_TYPE_SWITCH = "SWITCH";
export const PLACEMENT_TYPE_WEAPON_LAUNCHER = "WEAPON_LAUNCHER";
...
export const DEATH_TYPE_HEART = "HEART";
